              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className={`w-full rounded-md border ${formErrors.firstName ? 'border-red-300' : 'border-gray-300'} p-3 text-gray-700 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500`}
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full rounded-md border ${formErrors.lastName ? 'border-red-300' : 'border-gray-300'} p-3 text-gray-700 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500`}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-md border ${formErrors.email ? 'border-red-300' : 'border-gray-300'} p-3 text-gray-700 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500`}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full rounded-md border border-gray-300 p-3 text-gray-700 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-md border ${formErrors.subject ? 'border-red-300' : 'border-gray-300'} p-3 text-gray-700 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500`}
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-md border ${formErrors.message ? 'border-red-300' : 'border-gray-300'} p-3 text-gray-700 focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500`}
                ...
                <button
                  ...
                  className="inline-flex h-12 items-center justify-center rounded-md bg-orange-600 px-8 text-base font-medium text-white shadow-sm transition-colors hover:bg-orange-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-600 disabled:opacity-70"
                >
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex gap-4">
                        <a href="#" className="text-gray-500 hover:text-orange-500" aria-label="Facebook">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                          </svg>
                        </a>
                        <a href="#" className="text-gray-500 hover:text-orange-500" aria-label="Instagram">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <a href="#" className="text-gray-500 hover:text-orange-500" aria-label="Twitter">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
