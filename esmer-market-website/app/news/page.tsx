      ...
      <section className="w-full py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto rounded-lg border bg-white p-6">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-4">
                <h2 className="text-2xl font-bold">Reserve Special Products</h2>
                <p className="text-gray-700">
                  Pre-order limited-quantity specialty items or reserve fresh produce for pickup to ensure availability.
                </p>
              </div>
              <div className="flex items-center">
                <form className="w-full space-y-3">
                  <div>
                    ...
                    <select 
                      id="product"
                      className="w-full rounded-md border border-gray-300 p-2 text-sm focus:border-green-600 focus:outline-none focus:ring-1 focus:ring-green-600"
                    >
                      <option value="">Select a product</option>
                      <option value="organic-basket">Organic Seasonal Basket</option>
                      <option value="artisanal-cheese">Artisanal Cheese Selection</option>
                      <option value="premium-olive-oil">Premium Olive Oil (Limited)</option>
                      <option value="wine-collection">Special Wine Collection</option>
                    </select>
                  </div>
                  ...
                  <button
                    type="button"
                    className="w-full inline-flex h-10 items-center justify-center rounded-md bg-green-600 px-4 text-sm font-medium text-white shadow transition-colors hover:bg-green-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-green-700"
                  >
                    Reserve Product
                  </button>
                </form>
